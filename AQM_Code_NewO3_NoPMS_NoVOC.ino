...
#define COLLECT_NUMBER 50 //set colletion range (1-100)

#define led 13
#define tvocPin 7  // VOC sensor activation
#define dht22 5 // DHT22 temperature and humidity sensor

DFRobot_OzoneSensor Ozone; //create OzoneSensor object
...
void setup() {
  ...
  o3Serial.begin(9600); //o3 baud rate setting 
